...
WHY THIS RUN IS DIFFERENT FROM SLICE 72's
=========================================
...
PREVIOUS = "artifacts/slice72_promotion_gate.json"
SLICE = 73
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--out", default=os.path.join(
        REPO, "artifacts", "slice73_promotion_gate.json"))
    ...
    payload = {
        ...
        "items_complete_unchanged_from_slice_72":
    ...
    print("=" * 78)
    print("SLICE 73 — PROMOTION GATE   (re-evaluated against REAL forward data)")
    print("=" * 78)
    ...
    print(f"  items complete               : {payload['items_complete']} / "
          f"{payload['items_total']}   (unchanged from slice 72: "
          f"{payload['items_complete_unchanged_from_slice_72']})")
