...
WHY THIS RUN IS DIFFERENT FROM SLICE 69's
=========================================
...
PREVIOUS = "artifacts/slice69_promotion_gate.json"
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--out", default=os.path.join(
        REPO, "artifacts", "slice70_promotion_gate.json"))
    ...
    payload = {
        ...
        "items_complete_unchanged_from_slice_69":
    ...
    print("=" * 78)
    print("SLICE 70 — PROMOTION GATE   (re-evaluated against REAL forward data)")
    print("=" * 78)
    ...
    print(f"  items complete               : {payload['items_complete']} / "
          f"{payload['items_total']}   (unchanged from slice 69: "
          f"{payload['items_complete_unchanged_from_slice_69']})")
