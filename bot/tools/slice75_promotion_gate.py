...
WHY THIS RUN IS DIFFERENT FROM SLICE 74's
=========================================
...
PREVIOUS = "artifacts/slice74_promotion_gate.json"
SLICE = 75
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--out", default=os.path.join(
        REPO, "artifacts", "slice75_promotion_gate.json"))
    ...
    payload = {
        ...
        "items_complete_unchanged_from_slice_74":
    ...
    print(f"  items complete               : {payload['items_complete']} / "
          f"{payload['items_total']}   (unchanged from slice 74: "
          f"{payload['items_complete_unchanged_from_slice_74']})")
