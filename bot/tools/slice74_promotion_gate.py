...
WHY THIS RUN IS DIFFERENT FROM SLICE 73's
=========================================
...
PREVIOUS = "artifacts/slice73_promotion_gate.json"
SLICE = 74
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--out", default=os.path.join(
        REPO, "artifacts", "slice74_promotion_gate.json"))
    ...
    payload = {
        ...
        "items_complete_unchanged_from_slice_73":
    ...
    print("=" * 78)
    print("SLICE 74 — PROMOTION GATE   (re-evaluated against REAL forward data)")
    print("=" * 78)
    ...
    print(f"  items complete               : {payload['items_complete']} / "
          f"{payload['items_total']}   (unchanged from slice 73: "
          f"{payload['items_complete_unchanged_from_slice_73']})")
