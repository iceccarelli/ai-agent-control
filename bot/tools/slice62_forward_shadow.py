...
SCHEMA = "forward_shadow_observation/2"
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--out", default=os.path.join(
        REPO, "artifacts", "slice62_forward_shadow.json"))
    parser.add_argument("--log", default=os.path.join(
        REPO, "artifacts", "slice62_forward_shadow.log"))
    ...
    lines = [
        "=" * 78,
        "SLICE 62 — FORWARD SHADOW SEGMENT   (post-t1 bars only)",
        "=" * 78,
        "",
